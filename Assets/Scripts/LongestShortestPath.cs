...
public class LongestShortestPath : MonoBehaviour
{
    ...
    //returns true if an input point is within the bounds of the grid AND is NOT visited
    ...
    //node class to store information about a point in grid, and its distance to source point.
     class Node
    {
        public int row;
        public int col;
